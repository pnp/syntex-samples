...
All from a Power App: upload a benefits changes document to the app and a Syntex document understanding model will process the document and will extract metadata values from the document. Then using the extracted metadata with Syntex content assembly a custom service agreement will be generated and made available in the app.
