...
![Alt text](images/1-Process.png "Process Overview")
...
![Alt text](images/5-InvoiceReview-Details.png "Invoice review details")

### Invoice review line items
![Alt text](images/6-InvoiceReview-LineItems.png "Invoice review Line Items")

### Invoice approval history

![Alt text](images/7-InvoiceReview-Approvals.png "Invoice Approvals")
...
![Alt text](images/2-Schema.png "Schema")

Create the following library and list for this solution:

### Invoices Library

![Alt text](images/3-InvoicesLibrary.png "Invoices Library")

### Invoice Lines List

![Alt text](images/4-InvoiceLinesList.png "Invoice Lines List")
...
- SiteCollection – select the connection and add the site collection that will contain the Invoices Library and list.
    ...
    ![Alt text](images/8-SiteCollectionVariable.png "Site Collection Variable")

- Invoice Library – Select a connection and the library that will contain the invoice documents.

    ![Alt text](images/9-LibraryVariable.png "Invoice Library Variable")

- Invoice Lines – Select a connection and the list that will contain the invoice line items.

    ![Alt text](images/10-InvoiceLinesVariable.png "Invoice Lines Variable")
...
- Within the solution, Edit the Canvas App
    ...
    ![Alt text](images/11-PowerAppConfig.png "PowerAppConfig")
...
- Navigate to the Data Connections tab and delete and re-add the data connections to the Invoices and Invoice Lines objects in SharePoint.
    ...
    ![Alt text](images/12-PowerAppConfigDataConnections.png "PowerAppConfigDataSources")
